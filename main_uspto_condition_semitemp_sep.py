...
from utils.dataset import ConditionDataset, uspto_condition_map_final


from model import GATBase, RxnNetworkGNN, PositionalEncoding, SepSemiModel
from training import train_uspto_condition_sep, eval_uspto_condition_sep
import argparse
import os
import time
import pickle
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(
        ...
        shuffle=True, collate_fn=lambda x: uspto_condition_map_final(
    ...
    val_loader = DataLoader(
        ...
        shuffle=False, collate_fn=lambda x: uspto_condition_map_final(
