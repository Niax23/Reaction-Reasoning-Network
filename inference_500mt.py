...
import torch
import pickle
from inference_tools import beam_search
...
if __name__ == '__main__':
    ...
    for idx, line in enumerate(tqdm(all_data[2])):
        ...
        results = beam_search(
                model=model, tokenizer=remap, rxn=query_rxn,
                device=device, max_len=args.max_len, size=args.beam_size,end_token='<END>'
            )
