...
from utils.dataset import ConditionDataset, uspto_500mt_ablation
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--base_log', type=str, default='log_ab',
    ...
    train_loader = DataLoader(
        ...
        shuffle=True, collate_fn=uspto_500mt_ablation)

    val_loader = DataLoader(
        val_set, batch_size=args.bs, num_workers=args.num_workers,
        shuffle=False, collate_fn=uspto_500mt_ablation
    )
